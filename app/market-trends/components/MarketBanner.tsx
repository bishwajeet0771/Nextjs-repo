  ...
  return (
    <div className="relative p-[3%] w-full h-[140px] md:h-[160px] lg:h-[200px] flex flex-col justify-center items-center bg-gradient-to-r from-gray-500 to-[#cccccc] overflow-hidden animate-gradient">
      ...
      <TringleIcons
        number={1}
        className={
          "w-[60px] h-[60px] md:w-[160px] md:h-[160px] absolute top-[20px] left-[20px] "
        }
      />
      <TringleIcons
        number={2}
      ...
      {!path.includes("news") ? (
        <div className="relative flex flex-col items-center justify-center h-full ">
          {title && (
            <h2 className="text-[18px] md:text-[28px] text-white leading-[30px] shadow-[2px 2px 5px rgba(0, 0, 0, 1)] mb-0 md:mb-[16px] font-bold ">
              {title}
            </h2>
          )}
          {text && (
            <p className="text-[11px] text-[#cccccc] font-semibold mb-[20px] ">
              {text}
            </p>
          )}
        </div>
