...
export default function FiltersForListings({}: Props) {
  ...
  return (
    <section className=" container sm:mx-auto    px-1  sm:px-4">
      <div className="bg-card shadow-xl rounded-xl py-1 sm:p-6 z-[500] bg-white">
        <div className="flex  flex-row mt-2 sm:mt-0  items-start gap-2.5 rounded p-1.5 sm:border-[0.5px] border-solid border-[#819CA9] bg-white">
          ...
          <button
            onClick={onSearch}
            className="md:w-[40%] hidden sm:flex bg-primary hover:bg-primary/90 p-3 items-center justify-center gap-2  bg-btnPrimary text-white text-[14px] md:text-[16px] py-[4px] px-[8px] md:py-[6px] md:px-[12px] rounded-[4px] font-[600]"
            > 
            <FaSearch />
